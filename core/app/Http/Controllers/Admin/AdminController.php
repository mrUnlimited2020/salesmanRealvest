...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        // investment report
        $investTrx = Transaction::where(function ($query) {
        ...
        $profitTrx = Transaction::where('remark', 'profit')
            ->where('created_at', '>=', Carbon::now()->subDays(30))
            ->selectRaw("SUM(amount) as amount, DATE_FORMAT(created_at,'%Y-%m-%d') as date")
            ->orderBy('created_at')
            ->groupBy('date')
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'depositsMonth', 'withdrawalMonth', 'months', 'trxReport', 'plusTrx', 'minusTrx', 'property', 'investStatistics', 'investTrx', 'profitTrx'));
    }
