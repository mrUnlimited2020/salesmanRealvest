                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu p-0">
                                                    ...
                                                    <a href="" data-id="{{ $cron->id }}"
                                                        ...
                                                        class="dropdown-item updateCron">
...
@push('breadcrumb-plugins')
    <button type="btn" class="btn btn-outline--primary addCron">
        <i class="las la-plus"></i>@lang('Add')
    </button>
    <a href="{{ route('admin.cron.schedule') }}" class="btn btn-outline--primary">
        <i class="las la-clock"></i>@lang('Cron Schedule')
    </a>
@endpush
