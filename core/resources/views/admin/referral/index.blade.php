        ...
        <div class="col-lg-4 mb-4">
            <div class="card border--primary parent">
                <div class="card-header bg--primary">
                    ...
                    @if($general->$key == 0)
                        <a href="{{ route('admin.referrals.status',$key) }}" class="btn btn--success btn-sm float-end">
                            <i class="las la-toggle-on"></i>
                            @lang('Enable Now')
                        </a>
                    @else
                        <a href="{{ route('admin.referrals.status',$key) }}" class="btn btn--danger btn-sm float-end">
