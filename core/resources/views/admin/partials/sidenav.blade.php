        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.invest*', 3) }}">
                        <i class="menu-icon las la-stream"></i>
                        <span class="menu-title">@lang('Investment') </span>
                        @if ($pendingProfitCount > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.invest*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.running') }}">
                                <a href="{{ route('admin.invest.running') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Running Investment')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.completed') }}">
                                <a href="{{ route('admin.invest.completed') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Completed Investment')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.all') }}">
                                <a href="{{ route('admin.invest.all') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Investment')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.installment') }}">
                                <a href="{{ route('admin.invest.installment') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Installment Log')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.profit.pending') }}">
                                <a href="{{ route('admin.invest.profit.pending') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Profit')</span>
                                    @if ($pendingProfitCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingProfitCount }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.invest.profit') }}">
                                <a href="{{ route('admin.invest.profit') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Profit Log')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.manage*', 3) }}">
                        <i class="menu-icon las la-city"></i>
                        <span class="menu-title">@lang('Manage Properties')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.manage*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.manage.property.index') }} ">
                                <a href="{{ route('admin.manage.property.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Properties')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.manage.property.invested') }} ">
                                <a href="{{ route('admin.manage.property.invested') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Invested Properties')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.manage.time*') }} ">
                                <a href="{{ route('admin.manage.time.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Manage Time')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.manage.location*') }} ">
                                <a href="{{ route('admin.manage.location.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
