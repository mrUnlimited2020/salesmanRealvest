                                            ...
                                            <div class="user">
                                                <div class="thumb">
                                                    <img src="{{ getImage(getFilePath('language') . '/' . @$item->image, getFileSize('language')) }}"
                                                        alt="{{ __($item->name) }}" class="plugin_bg">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <x-image-uploader :imagePath="getImage(null, getFileSize('language'))" :size="false" class="w-100" id="imageCreate"
                                    :required="true" />
                            </div>
                        </div>
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label> @lang('Image')</label>
                            <x-image-uploader :imagePath="getImage(null, getFileSize('language'))" :size="false" class="w-100" id="imageEdit"
                                :required="false" />
                        </div>
                        <div class="form-group">
                            <label>@lang('Language Name')</label>
