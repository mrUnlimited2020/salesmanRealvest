            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--3">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $propertyInvest['total_invested_property'] }}</h3>
                            <p class="text-white">@lang('Invested Property')</p>
                        </div>
                        <a href="{{ route('admin.invest.all') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($propertyInvest['total_invest']) }}</h3>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--10">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($propertyInvest['total_due_amount']) }}</h3>
                            <p class="text-white">@lang('Due Amount')</p>
                        </div>
                        <a href="{{ route('admin.invest.all') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--11">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($propertyInvest['total_profit']) }}</h3>
                            <p class="text-white">@lang('Total Profit')</p>
                        </div>
                        <a href="{{ route('admin.invest.profit') }}?search={{ $user->username }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            </div>
